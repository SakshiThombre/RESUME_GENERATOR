         ...
         <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 marg">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="margin:50px 0px 0px 0px;">
                ...
                <div class="panel panel-default" style=" box-shadow: 10px 10px 10px #333;">
                      <div class="panel-heading">
                            <h3 class="panel-title">Add Hobbies</h3>
                      </div>
                      <div class="panel-body">
                            
                            <form action="hobbiessave.php" method="POST" role="form" >

                            <?php
                                $id=$_SESSION["id"];
                                $sql="select max(srno) from tblhobbies where id='$id'";
                            ...
                            ?>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="txth" name="txth" placeholder="Hobbies">
                                    </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="margin:50px 0px 0px 0px;">
                ...
                <div class="panel panel-default" style=" box-shadow: 10px 10px 10px #333;">
                                ...
                                if(mysqli_num_rows($res)>0)
                                {
                                    while($row=mysqli_fetch_array($res))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a href="hobbiessave.php?btndelete=delete&srno=<?php echo $row["srno"]; ?>" type="button" class="btn btn-danger">
                      ...
                      <a href="upload.php" class="glyphicon glyphicon-arrow-right" id="icon" aria-hidden="true"></a>
                </div>
