    ...
    <body>
         ...
         <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 marg">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="margin:50px 0px 0px 0px;">
                ...
                <div class="panel panel-default"  style=" box-shadow: 10px 10px 10px #333;">
                      <div class="panel-heading">
                            <h3 class="panel-title">Add Media & Links</h3>
                      </div>
                      <div class="panel-body">
                            
                            <form action="linksave.php" method="POST" role="form" >
                            <?php
                                $id=$_SESSION["id"];
                            ...
                            ?>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="txtmt" name="txtmt" placeholder="Media type">
                                    </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="margin:50px 0px 0px 0px;">
                ...
                <div class="panel panel-default"  style=" box-shadow: 10px 10px 10px #333;">
                      <div class="panel-heading">
                            <h3 class="panel-title">Media & Links</h3>
                      </div>
                      <div class="panel-body">
                      <table class="table table-bordered table-hover" id="data">
                                ...
                                if(mysqli_num_rows($res)>0)
                                {
                                    while($row=mysqli_fetch_array($res))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a href="linksave.php?btndelete=delete&srno=<?php echo $row["srno"]; ?>" type="button" class="btn btn-danger">
                            ...
                            <a href="personal.php" class="glyphicon glyphicon-arrow-right" id="icon" aria-hidden="true"></a>
                      </div>
